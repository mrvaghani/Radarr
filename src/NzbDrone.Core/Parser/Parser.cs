...
namespace NzbDrone.Core.Parser
{
    public static class Parser
    {
       ...
       // name only...BE VERY CAREFUL WITH THIS, HIGH CHANCE OF FALSE POSITIVES
        private static readonly Regex ExceptionReleaseGroupRegexExact = new Regex(@"(?<releasegroup>KRaLiMaRKo|E\.N\.D|D\-Z0N3|Koten_Gars)", RegexOptions.IgnoreCase | RegexOptions.Compiled);
